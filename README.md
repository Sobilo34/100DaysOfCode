...
|Day|Topic|Day|Topic|
|:---:|:----:|:---:|:----:|
|[Day 01](Progress_tracker.md#day-0-october-29-2023) **13/03/24**| **JavaScript:** Objects,Scopes and Closure - How use Objects, Scopes and Closure In JavaScript [**View Code**](https://github.com/Sobilo34/my_practice/tree/main/Javascipt/javascript_objects_scopes_closures)  | [Day 02](Progress_tracker.md#day-1-october-30-2023) **14/03/24**| **C Language:** Pointers, Arrays and Strings - Revise the concept of Pointers, Arrys and Strings in C ans wrote a program with it |
<!--
