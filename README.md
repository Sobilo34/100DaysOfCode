...
|:---:|:-----:|:----:|:------------|:-----|
| 01 | [**JavaScript**:](bilggg.md) Objects, Scopes and Closure | 13/03/24 | Learn Objects, Scopes, and Closure in JavaScript | [**View Codes**](https://github.com/Sobilo34/my_practice/tree/main/Javascript/Day_01_100DaysOfCode_javascript) |
...
| 06 | **Python**: Game that find Treasure | 18/03/24 | Build a game that finds a treasure in a big house played by moving to diffent directions | [**View Code**](https://github.com/Sobilo34/my_practice/blob/main/C-Language/Day_04_100DaysOfCode.c) |
